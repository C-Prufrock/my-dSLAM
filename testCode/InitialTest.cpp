...
void DrawMatches(const vector<int>mvIniMatches,Frame mCurrentFrame1,Frame mCurrentFrame2,cv::Mat ImgRgb1,cv::Mat ImgRgb2,cv::Mat& outImg,int& nmatches)
{
    ...
    cv::Mat roi2=outImg(cv::Rect(width,0,width,height));
    ImgRgb1.copyTo(roi1);
    ImgRgb2.copyTo(roi2);
...
int main()
{
    ...
    for(int ni=0;ni<nImages;ni+=2)
    {
        ...
        //建立特征提取器
        ORB_SLAM2::ORBextractor *mpORBextractor = new ORBextractor(ORBExtractorParameter->nFeatures,ORBExtractorParameter->fScaleFactor, ORBExtractorParameter->nLevels, ORBExtractorParameter->fIniThFAST, ORBExtractorParameter->fMinThFAST);
        ORB_SLAM2::ORBextractor *mpORBextractor2 = new ORBextractor(ORBExtractorParameter->nFeatures,ORBExtractorParameter->fScaleFactor, ORBExtractorParameter->nLevels, ORBExtractorParameter->fIniThFAST, ORBExtractorParameter->fMinThFAST);
